    ...
    <div class="page-header">
        <div class="header-wrapper row m-0">
            <div class="header-logo-wrapper col-auto p-0">
                <div class="logo-wrapper"><a href="index-kit.html"><img class="img-fluid" src="<%= BASE_URL %>assets/images/logo/logo.png"
                                                                        alt=""></a></div>
                ...
                <ul class="nav-menus">
                    ...
                    <li class="onhover-dropdown">
                        ...
                        <div class="onhover-show-div notification-dropdown">
                            ...
                            <ul class="custom-scrollbar">
                                <li>
                                    <div class="media">
                                        <div class="notification-img bg-light-primary"><img src="<%= BASE_URL %>assets/images/avtar/man.png" alt="">
                                        </div>
                    ...
                    <li class="profile-nav onhover-dropdown pe-0 py-0 me-0">
                        ...
                        <ul class="profile-dropdown onhover-show-div">
                            ...
                            <li><a href="login.html"><i data-feather="log-in"> </i><span>خروج</span></a></li>
                        </ul>
                    </li>
                </ul>
            </div>
